...
export const PromptInputActionAddAttachments = ({
  ...
  const handleClick = useCallback<DropdownMenuItemClick>(
    (e) => {
      e.preventDefault();
...
export const PromptInputSubmit = ({
  ...
  let Icon = <CornerDownLeftIcon aria-hidden className="size-4" />;

  if (status === "streaming") {
    Icon = <SquareIcon aria-hidden className="size-4" />;
  } else if (status === "error") {
    Icon = <XIcon aria-hidden className="size-4" />;
  }
